...
function getGridColumn(seatNumber) {
    const colChar = seatNumber.charAt(seatNumber.length - 1);
    switch (colChar) {
        case 'A': return 1;
        case 'B': return 2;
        case 'C': return 3;
...
function getGridRow(seatNumber) {
    const rowPart = seatNumber.substring(0, seatNumber.length - 1);
    return parseInt(rowPart, 10);
}
                ...
                <div className="pref-field">
                    <div className="checkbox-field">
                        ...
                        <label htmlFor="legroomPref">
                            Extra Legroom
                            <span className="pref-badge-xl">XL</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="pref-field">
                    <div className="checkbox-field">
                        ...
                        <label htmlFor="exitRowPref">
                            Exit Row
                            <span className="pref-badge-ex">EX</span>
                        </label>
                    </div>
                </div>
            ...
            <div className="seat-map-section">
                ...
                <div className="seat-map-container">
                    {seats.map((seat) => {
                        ...
                        const col = getGridColumn(seat.seatNumber);
                        const row = getGridRow(seat.seatNumber);
